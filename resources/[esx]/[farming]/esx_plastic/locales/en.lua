Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'Drücke ~INPUT_CONTEXT~ um ~g~Kautschuk~s~ abzubauen.',
  ['weed_inventoryfull'] = 'Du hast kein Platz mehr für ~g~Kautschuk~s~.',
  ['weed_processprompt'] = 'Drücke ~INPUT_CONTEXT~ um die ~g~Plastikverarbeitung~s~ zu starten.',
  ...
  ['weed_processed'] = 'Du hast ~b~3x~s~ ~g~Kautschuk~s~ zu ~b~1x~s~ ~g~Plastic~s~ verarbeitet',
  ...
  -- blips
  ['blip_weedfield'] = 'Kautschukfeld',
  ['blip_weedprocessing'] = 'Plastikverarbeiter',
