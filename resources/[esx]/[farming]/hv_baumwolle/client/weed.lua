...
function ProcessWeed()
	...
	TriggerServerEvent('esx_drugs:processbaumwolle')
			...
			if IsControlJustReleased(0, 38) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_drugs:canPickUp', function(canPickUp)
					if canPickUp then
						...
						TriggerServerEvent('esx_drugs:pickedUpbaumwolle')
					else
...
function SpawnWeedPlants()
	while spawnedWeeds < 25 do
		...
		ESX.Game.SpawnLocalObject('prop_bush_ivy_01_pot', weedCoords, function(obj)  -- Spawnprop
