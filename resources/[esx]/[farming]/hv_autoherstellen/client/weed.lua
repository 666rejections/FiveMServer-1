...
function ProcessWeed()
	...
	TriggerServerEvent('esx_drugs:processKohle')
   ...
   local vehicleData = adder
	SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function(vehicle)
			...
			if IsControlJustReleased(0, 38) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_drugs:canPickUp', function(canPickUp)
					if canPickUp then
						...
						TriggerServerEvent('esx_drugs:pickedUpKohle')
					else
...
function SpawnWeedPlants()
	while spawnedWeeds < 25 do
		...
		ESX.Game.SpawnLocalObject('prop_coral_stone_04', weedCoords, function(obj)  -- Spawnprop
