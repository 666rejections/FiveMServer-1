Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'Drücke ~INPUT_CONTEXT~ um ~g~Kohleerz~s~ abzubauen.',
  ['weed_inventoryfull'] = 'Du hast kein Platz mehr für ~g~Kohleerz~s~.',
