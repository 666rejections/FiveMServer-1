Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'Drücke ~INPUT_CONTEXT~ um ~g~Bauxierz~s~ abzubauen.',
  ['weed_inventoryfull'] = 'Du hast kein Platz mehr für ~g~Bauxierz~s~.',
