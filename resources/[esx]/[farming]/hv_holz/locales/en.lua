Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'Drücke ~INPUT_CONTEXT~ um ~g~Fichtenholz~s~ abzubauen.',
  ['weed_inventoryfull'] = 'Du hast kein Platz mehr für ~g~Fichtenholz~s~.',
  ...
  -- blips
  ['blip_weedfield'] = 'Fichtenholzfeld',
