Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'Das Fahrzeug mit dem Nummernschild~y~%s~s~ gehört nun ~b~dir~s~',
  ['broke_company']           = 'you do not have enough money in the company account',
  ['license_missing']         = 'Du besitzt keinen Führerschein',
  ...
  ['shop_awaiting_model']     = 'Das Fahrzeug läst gerade, bitte warte',
