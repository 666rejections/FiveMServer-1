...
var MainDigits = 1;
var RotationTime = 55000; // time ms
var RotationDegree = 3180*(RotationTime/35000);
var HitDistance = 55; // hit distance in px
var killTimeout;
var active = false;
...
function init($param) {
    var angle = Math.floor((Math.random() * 720) - 60);
    $("#circle2").rotate(angle);
    $("#container > p").html("Drücke");
    if($param!=1)
        $("#container > p").append("<br><h4>hier</h4>");
    else
        $("#container > p").append("<br><h4>hier</h4>");
    $('.time').addClass('done');
}
