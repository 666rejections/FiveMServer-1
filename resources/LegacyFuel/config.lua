...
Config.Strings = {
	ExitVehicle = "Verlasse das Fahrzeug",
	EToRefuel = "Drücke ~g~E ~w~um das Fahrzeug zu betanken",
	JerryCanEmpty = "Kanister ist leer",
	FullTank = "Tank ist voll",
	PurchaseJerryCan = "Drücke ~g~E ~w~to um einen Kanister für ~g~$ zu kaufen" .. Config.JerryCanCost,
	CancelFuelingPump = "Drücke ~g~E ~w~um das betanken abzubrechen",
	CancelFuelingJerryCan = "Drücke ~g~E ~w~um das betanken abzubrechen",
	NotEnoughCash = "Nicht genug Geld",
	RefillJerryCan = "Drücke ~g~E ~w~ um den Kanister nachzufüllen ",
	NotEnoughCashJerryCan = "Nicht genug Geld um den Kanister nachzufüllen",
	JerryCanFull = "Kanister ist voll",
	TotalCost = "Kosten",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Drücke ~g~E ~w~um den Kanister zu kaufen"
	Config.Strings.RefillJerryCan = "Drücke ~g~E ~w~ um den Kanister nachzufüllen"
end
